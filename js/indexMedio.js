...
function cargarPregunta(index){
    objetoPregunta = baseDePreguntasMedio[index]
...
async function seleccionarOpcion(index) {
    ...
    INDEX_PREGUNTA++;
    if (INDEX_PREGUNTA >= baseDePreguntasMedio.length){
        INDEX_PREGUNTA = 0;
        await Swal.fire({
            title:"Juego terminado",
            html:`<span class="subtitulo-ventana">Tu puntaje es de: ${puntaje}/${baseDePreguntasMedio.length}</span>`,
